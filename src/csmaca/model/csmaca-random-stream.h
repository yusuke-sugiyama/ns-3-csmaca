 ...
 */
#ifndef SIMPLE_RANDOM_STREAM_H
#define SIMPLE_RANDOM_STREAM_H
...
/**
 * A csmaca wrapper around RngStream to make testing
 * of the code easier.
 */
class CsmacaRandomStream
{
public:
  virtual ~CsmacaRandomStream ();
  /**
...
class CsmacaRealRandomStream : public CsmacaRandomStream
{
public:
  CsmacaRealRandomStream ();
